...
def replace_numbers_with_words(input_file, output_file, confidence_threshold):
    ...
    mapping = {
        ...
        "2435": ("power", 3),
        "3478":("beholder",3),        
        "27560192889521973536": ("knowledge", 3),
        "21191180035765135": ("language", 2),
        "561145727857261185": ("they", 3),
        "0512164856114519199118003646889521991180065128": ("understand", 2),
        "18003646889521991180065128895236": ("deciphering", 2),
        "9727839": ("secrets", 2)
    }
