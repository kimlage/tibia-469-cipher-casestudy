...
`2`, as the current strongest copy/reference fabrication bound at roughly
`8805.7` bits. Follow-up single/pair local repairs and all compatible local
repair sets above one do not
