...
Verdict: `post_itemctx_param_copy_order_optimistic_only_not_promoted`. Translation delta: `NONE`.
...
|---|---:|---:|---:|---:|---:|
| `best_midpoint_alpha1_copy_order_optimistic_no_mode` | `4912.746` | `8558.253` | `-3.539` | `False` | `258` |
| `source_first_then_midpoint_alpha1_length_active` | `4916.285` | `8561.792` | `-0.000` | `True` | `0` |
| `midpoint_alpha1_copy_order_sparse_run_list_length_first_required` | `4925.264` | `8570.771` | `8.979` | `True` | `2` |
| `midpoint_alpha1_length_first_then_source` | `4928.480` | `8573.986` | `12.194` | `True` | `283` |
| `midpoint_alpha1_copy_order_mode_per_copy` | `5195.746` | `8841.253` | `279.461` | `True` | `258` |
