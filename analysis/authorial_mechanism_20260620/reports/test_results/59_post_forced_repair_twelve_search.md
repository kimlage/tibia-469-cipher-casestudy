...
Verdict: `post_forced_repair_twelve_not_promoted`. Translation delta: `NONE`.
...
| Compatible twelve-repair sets tested | `184756` |
| Incompatible twelve-repair sets skipped | `461890` |
| Best single delta | `0.7` |
| Best twelve-repair total bits | `8943.4` |
| Best twelve-repair delta vs current | `20.6` |
