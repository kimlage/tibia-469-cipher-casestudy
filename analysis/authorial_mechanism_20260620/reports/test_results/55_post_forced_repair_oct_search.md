...
Verdict: `post_forced_repair_oct_not_promoted`. Translation delta: `NONE`.
...
| Compatible octets tested | `195806` |
| Incompatible octets skipped | `123964` |
| Best single delta | `0.7` |
| Best octet total bits | `8933.8` |
| Best octet delta vs current | `11.0` |
