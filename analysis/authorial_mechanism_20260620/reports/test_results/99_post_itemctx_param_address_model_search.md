...
Verdict: `post_itemctx_param_address_optimistic_only_not_promoted`. Translation delta: `NONE`.
...
|---|---:|---:|---:|---:|---:|
| `literal_seed_address_optimistic_no_mode` | `4846.9` | `8492.4` | `-69.4` | `False` | `27` |
| `absolute_digit_source_pos_min_len_bounded` | `4916.3` | `8561.8` | `-0.0` | `True` | `0` |
| `literal_seed_sparse_run_list_seed_required` | `4925.3` | `8570.9` | `9.1` | `True` | `1` |
| `literal_seed_address_conservative_mode_per_copy` | `5129.9` | `8775.4` | `213.6` | `True` | `27` |
| `book_delta_digit_offset_delta_gamma` | `6641.5` | `10287.0` | `1725.2` | `True` | `0` |
| `book_delta_digit_offset_gamma` | `6789.5` | `10435.0` | `1873.2` | `True` | `0` |
| `digit_back_distance_delta_gamma` | `6809.5` | `10455.0` | `1893.2` | `True` | `0` |
| `source_digit_pos_delta_gamma` | `6900.5` | `10546.0` | `1984.2` | `True` | `0` |
| `mixed_same_book_digit_distance_else_book_offset` | `7057.5` | `10703.0` | `2141.2` | `True` | `0` |
| `digit_back_distance_gamma` | `7698.5` | `11344.0` | `2782.2` | `True` | `0` |
