...
def main() -> None:
    ...
    if best_decodable["model"] != "absolute_flat_source_pos" and best_decodable["total_bits"] < current_bits:
        classification = "post_repair_address_model_candidate"
    elif best_any["total_bits"] < current_bits and not best_any["decodable"]:
        classification = "post_repair_address_optimistic_only_not_promoted"
    else:
        classification = "post_repair_address_absolute_retained"

    result = {
        "schema": "post_repair_address_model_search.v1",
        "test": "31_post_repair_address_model_search",
    ...
    write_result("31_post_repair_address_model_search", result, lines)
