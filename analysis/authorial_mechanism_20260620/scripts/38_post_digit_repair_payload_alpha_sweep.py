...
def main() -> None:
    ...
    best = rows[0]
    classification = (
        "post_digit_repair_payload_alpha_retains_14"
        if best["alpha"] == current_alpha
        else "post_digit_repair_payload_alpha_candidate"
    )

    result = {
        "schema": "post_digit_repair_payload_alpha_sweep.v1",
        "test": "38_post_digit_repair_payload_alpha_sweep",
    ...
    write_result("38_post_digit_repair_payload_alpha_sweep", result, lines)
