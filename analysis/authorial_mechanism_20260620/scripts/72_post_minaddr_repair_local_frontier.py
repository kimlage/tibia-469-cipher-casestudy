...
FORMULA = HERE / "sequential_lz_digit_address_contextual_bounded_copy_length_minaddr_repair_formula_469.json"
OUT_FORMULA = HERE / "sequential_lz_digit_address_contextual_bounded_copy_length_minaddr_repair2_formula_469.json"
BOOKS_DIGITS = ROOT / "analysis/audit_20260609/books_digits.json"
FRONTIER = HERE / "scripts/71_minaddr_local_frontier.py"

CURRENT_TOTAL_KEY = "sequential_lz_digit_address_contextual_bounded_copy_length_minaddr_repair_bits"
OUT_TOTAL_KEY = "sequential_lz_digit_address_contextual_bounded_copy_length_minaddr_repair2_bits"
...
def main() -> None:
    ...
    classification = (
        "controlled_post_minaddr_repair_local_improvement"
        if promoted
        else "post_minaddr_repair_local_frontier_closed"
    )
    ...
    if promoted:
        ...
        out.update(
            {
                "schema": "sequential_lz_digit_address_contextual_bounded_copy_length_minaddr_repair2_formula.v1",
                ...
                "mdl_estimate_rough": {
                    **out["mdl_estimate_rough"],
                    ...
                    "previous_sequential_lz_digit_address_contextual_bounded_copy_length_minaddr_repair_bits": current_bits,
                    "gain_vs_previous_minaddr_repair_bits": current_bits - score["total_bits"],
                ...
                "post_minaddr_repair_local_repair": {
                    key: value for key, value in best.items() if key != "score"
                },
                "validation": {
                    **out["validation"],
                    "post_minaddr_repair_local_roundtrip_audit": score["validation"],
    ...
    result = {
        "schema": "post_minaddr_repair_local_frontier.v1",
        "test": "72_post_minaddr_repair_local_frontier",
        "classification": classification,
        "translation_delta": "NONE",
        ...
        "best_repair": best,
        "promotion_rule": (
            "promote only if one exact local edit after the first minaddr repair beats "
    ...
    write_result("72_post_minaddr_repair_local_frontier", result, lines)
